...
public class CheapestInsertion {
	...
	public static void main(String[] args) throws IOException {
		...
		List<Point> trajectory = competition.algorithms.vtsp.insertion.storingtrajectories.CheapestInsertion.
				cheapestInsertion(NearestNeighbor.nearestNeighbor(cities));
